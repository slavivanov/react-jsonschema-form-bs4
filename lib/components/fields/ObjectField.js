...
function DefaultObjectFieldTemplate(props) {
  ...
  return _react2.default.createElement(
    ...
    canExpand() && _react2.default.createElement(AddButtonComponent, {
...
var ObjectField = function (_Component) {
  ...
  function ObjectField() {
    ...
    }, _this.handleAddClick = function (schema, uiSchema) {
      return function () {
        var type = schema.additionalProperties.type;
        var newFormData = (0, _extends6.default)({}, _this.props.formData);
        var keyName = uiSchema.additionalPropertiesKeyName || "Key";

        newFormData[_this.getAvailableKey(keyName, newFormData)] = _this.getDefaultValue(type);
  ...
  (0, _createClass3.default)(ObjectField, [{
    ...
    value: function render() {
      ...
      var AddButtonTemplate = registry.AddButtonTemplate;
