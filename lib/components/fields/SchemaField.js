...
exports.WrapIfAdditional = WrapIfAdditional;
...
function WrapIfAdditional(props) {
  ...
  var RemoveButton = RemoveButtonTemplate || _IconButton2.default;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        "div",
        { className: "col form-additional" },
        _react2.default.createElement(
          "div",
          { className: "form-group" },
          displayLabel && _react2.default.createElement(Label, { label: keyLabel, required: required, id: id + "-key" }),
      ...
      _react2.default.createElement(
        "div",
        { className: "form-additional form-group col" },
        props.children
      ),
      _react2.default.createElement(
        "div",
...
function SchemaFieldRender(props) {
  ...
  var classNames = ["form-group", "field", "field-" + type, errors && errors.length > 0 ? "field-error text-danger" : "", uiSchema.classNames].join(" ").trim();
